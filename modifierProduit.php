...
<tr>
<td></td>
<td><input type="submit" name="modifier" value="modifier" id="mod"></td>
</tr>
<tr>
<td></td>
<td><input type="hidden" name="IDi_ini" value="<?PHP echo $_GET['ID_produit'];?>"></td>
</tr>
</table>
</form>
<?PHP
...
if (isset($_POST['modifier'])){
	$produit=new Produit($_POST['nom'],$_POST['prix']);
	$produit->setID_produit($_POST['IDi_ini']);
...
alert("Modificiation avec succees");
});
  });
  </script>
  <script type="text/javascript">
