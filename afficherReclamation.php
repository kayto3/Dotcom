...
<body>
  ...
  <!--main content start-->
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Reclamations </h3>
        <!-- row -->
        <div class="row mt">
          <div class="col-md-12">
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> Nom Utilisateur</th>
                    <th><i class="fa fa-bookmark"></i> Profit</th>
          <th><i class=" fa fa-edit"></i> Status</th>
          <th><i class=" fa fa-edit"></i> Fin de reclamation</th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
        ...
        ?>
          ...
          <td><span class="label label-warning label-mini"><?PHP echo $row['mail']; ?>%</span></td>
  ...
  <input type="hidden" value="<?PHP echo $row['ref']; ?>" name="ref">
    ...
    <?PHP
      ...
      ?>
      <form method="POST">
      <p>Modifier reclamation</p>
      <div style="color:black;" class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i>Ajouter reclamation</h4>
              ...
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="get" action="">
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="cid" name="ref" minlength="2" type="text"  value="<?PHP echo $ref ?>" required />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="cenom" class="control-label col-lg-2">Nom Produit</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="cnom" name="nom" type="text" value="<?PHP echo $nom ?>" required />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="Objet" class="control-label col-lg-2">Prix Avant reclamation</label>
                    <div class="col-lg-2">
                      <input class="form-control " id="cObjet" type="number" name="Objet" value="<?PHP echo $Objet ?>" />
                    </div>
                  </div>
                  <div class="form-group ">
                      <label for="mail" class="control-label col-lg-2">mail (%)</label>
                      <div class="col-lg-2">
                        <input class="form-control " id="cmail" type="number" name="mail" value="<?PHP echo $mail ?>" />
                      </div>
                    </div>
                    <!--
                  <div class="form-group ">
                    <label for="cmail" class="control-label col-lg-2">mail (%)</label>
                    <div class="col-lg-10">
                      <form class="form-control " id="cmail" name="mail" required>
                          <select name="mail">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-md-3 col-xs-11">
                      <input class="form-control form-control-inline input-medium default-date-picker" size="16" type="date" value="<?PHP echo $date ?>" name="date">
    ...
    if (isset($_POST['modifier'])){
      $reclamation=new reclamation($_POST['id'],$_POST['nom'],$_POST['Objet'],$_POST['mail'],$_POST['date']);
      $reclamationC->modifierReclamation($reclamation,$_POST['ref_ini']);
      echo $_POST['ref_ini'];
      header("Refresh");
    }
    ?>
